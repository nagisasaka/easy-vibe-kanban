...
fn descriptor(
    ...
    label: &str,
    description: &str,
    input: (SettingValueType, SettingControl),
...
fn codex_descriptors() -> Vec<SettingDescriptor> {
    vec![
        descriptor(
            ...
            (SettingValueType::String, SettingControl::Text),
            &common_locations(&["model"]),
            true,
        ),
        select_options(
            descriptor(
                SettingKey::new("common", "reasoning"),
                SettingSection::General,
                "Reasoning effort",
                "Default model reasoning effort.",
                (SettingValueType::String, SettingControl::Select),
        ...
        select_options(
            descriptor(
                SettingKey::new("common", "approval_policy"),
        ...
        select_options(
            descriptor(
                SettingKey::new("common", "sandbox_mode"),
                SettingSection::PermissionsSandbox,
                "Sandbox mode",
...
fn claude_descriptors() -> Vec<SettingDescriptor> {
    vec![
        ...
        select_options(
            descriptor(
                SettingKey::new("common", "permission_mode"),
                SettingSection::PermissionsSandbox,
                "Permission mode",
        ...
        descriptor(
            SettingKey::new("claude_code", "permission_allow"),
            SettingSection::PermissionsSandbox,
            "Allowed tools",
            "Native Claude Code allow rules.",
            (SettingValueType::StringList, SettingControl::StringList),
            &common_settings_locations(&["permissions", "allow"]),
            false,
        ),
        descriptor(
            SettingKey::new("claude_code", "permission_deny"),
            SettingSection::PermissionsSandbox,
            "Denied tools",
        ...
        descriptor(
            SettingKey::new("claude_code", "output_style"),
            SettingSection::ProviderSettings,
            "Output style",
        ...
        descriptor(
            SettingKey::new("claude_code", "enabled_plugins"),
            SettingSection::ProviderSettings,
            "Enabled plugins",
        ...
        descriptor(
            SettingKey::new("claude_code", "hooks"),
            SettingSection::ProviderSettings,
            "Hooks",
            "Claude Code hook definitions. Advanced JSON preserves provider-specific shapes.",
            (SettingValueType::Json, SettingControl::Json),
            &common_settings_locations(&["hooks"]),
            false,
        ),
        descriptor(
            SettingKey::new("claude_code", "status_line"),
            SettingSection::ProviderSettings,
            "Status line",
...
fn gemini_descriptors() -> Vec<SettingDescriptor> {
    vec![
        ...
        descriptor(
            SettingKey::new("common", "sandbox_enabled"),
            SettingSection::PermissionsSandbox,
            "Sandbox",
        ...
        descriptor(
            SettingKey::new("gemini", "allowed_tools"),
            SettingSection::PermissionsSandbox,
            "Allowed tools",
        ...
        descriptor(
            SettingKey::new("gemini", "excluded_tools"),
            SettingSection::PermissionsSandbox,
            "Excluded tools",
        ...
        descriptor(
            SettingKey::new("gemini", "checkpointing"),
            SettingSection::ProviderSettings,
            "Checkpointing",
        ...
        descriptor(
            SettingKey::new("gemini", "telemetry"),
            SettingSection::ProviderSettings,
            "Telemetry",
...
fn oh_my_pi_descriptors() -> Vec<SettingDescriptor> {
    ...
    vec![
        descriptor(
            SettingKey::new("oh_my_pi", "extensions"),
            SettingSection::ProviderSettings,
            "Extensions",
        ...
        descriptor(
            SettingKey::new("oh_my_pi", "disabled_extensions"),
            SettingSection::ProviderSettings,
            "Disabled extensions",
        ...
        descriptor(
            SettingKey::new("oh_my_pi", "light_theme"),
            SettingSection::ProviderSettings,
            "Light theme",
        ...
        descriptor(
            SettingKey::new("oh_my_pi", "compaction_enabled"),
            SettingSection::ProviderSettings,
            "Compaction",
        ...
        descriptor(
            SettingKey::new("oh_my_pi", "startup_quiet"),
            SettingSection::General,
            "Quiet startup",
...
mod tests {
    ...
    fn snapshot(
        inventory: &AgentSettingsInventory,
        provider: AgentSettingsProvider,
    ) -> &SettingsSnapshot {
        inventory
            .providers
